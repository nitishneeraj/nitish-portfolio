...
const Navbar = () => {
  ...
  function handleNewPage() {
    window.open(
      `https://drive.google.com/file/d/1_8R7YQunKOPYmHCDktnhM5QaDHnKytH1/view?usp=sharing`,
      "_blank",
    );
  }
  ...
  return (
    ...
    >
      <div className="flex justify-center items-center font-extrabold">
        <div id="user-detail-name">Nitish</div>
      </div>
      ...
      <ul className="hidden md:flex">
        ...
        <li id="resume-button-1" className="nav-link resume">
          <a id="resume-link-1" href={Resume} download="Nitish-Resume.pdf">
            Resume
          </a>
        </li>
      </ul>
      ...
      >
        ...
        <li className="nav-link resume py-6 text-4xl">
          <a href={Resume} onClick={handleNewPage} download={"Nitish-Resume"}>
            Resume
          </a>
        </li>
      </ul>
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <a
              ...
              href="https://www.linkedin.com/in/nitish-686698217/"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="mailto:nitishneeraj16@gmail.com"
            >
